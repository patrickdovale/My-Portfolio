...
export default function Skill() {
  ...
  function showHability() {
    return uniqueCategory.map((category,i) => (
      <div className="skill-section" key={i}>
        ...
        <div className="skill-body">
          {skills
            .filter((skillItem) => skillItem.category === category)
                ...
                <div className="skill-progress">
                  <div className="progress-bar">
                    <div
                      ...
                      style={{ width: skillItem.conhecimento / 2 }}
                    />
                  </div>
                  <p>{`${skillItem.conhecimento}%`}</p>
                </div>
              </div>
            ))}
        </div>
  ...
  return (
    <div id="skill">
      <div className="container">
        ...
        <div className="container-skill">{showHability()}</div>
      </div>
    </div>
  );
}
