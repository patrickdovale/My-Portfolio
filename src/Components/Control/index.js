  ...
  return (
    <div className="box-control">
      <BsFillGearFill
        ...
        value={Language}
        onClick={() =>
          !controlSelect ? setControlSelect(true) : setControlSelect(false)
        }
      />
      <div
        className="box-options"
        style={
          controlSelect === true ? { display: "flex" } : { display: "none" }
        }
      >
        <div className="toggle">
          ...
          <label className="box-toggle" type="label" htmlFor="language">
            <img src={brasil} alt="Bandeira Brasil" className="icone-mode" />
            <img
              src={eua}
              alt="Bandeira EUA"
              className="icone-mode"
            />
            <div
              className={`${
                Language === "pt-BR" ? "toggle-active" : ""
              } indicator`}
            ></div>
          </label>
        </div>
